...
function NavItem({ link }: { link: NavLink }) {
  ...
  if (link.children) {
    return (
      ...
      >
        <span className="cursor-pointer px-3 py-2 font-semibold text-gray-900 hover:text-[var(--color-primary)] flex justify-between items-center gap-1 w-full">
          {link.label}
  ...
  return (
    <li>
      <Link href={link.href!} className="px-3 py-2 text-gray-900 hover:text-[var(--color-primary)] font-semibold block">
        {link.label}
      </Link>
    </li>
  );
...
function NavSubItem({ link, level = 1 }: { link: NavLink; level?: number }) {
  ...
  if (link.children) {
    return (
      <li
        ...
        onMouseLeave={handleMouseLeave}
      >
        <span className="cursor-pointer px-3 py-2 font-semibold text-gray-900 hover:text-[var(--color-primary)] flex items-center gap-1">
          {link.label}
  ...
  return (
    <li>
      <Link href={link.href!} className="px-3 py-2 text-gray-900 hover:text-[var(--color-primary)] font-semibold block whitespace-nowrap w-full flex justify-between items-center">
        {link.label}
      </Link>
    </li>
  );
