    ...
    <>
      ...
      <form>
        ...
        <div className="mt-6 space-y-3">
          <button className="btn w-full bg-linear-to-t from-[var(--color-primary)] to-[var(--color-light-40)] bg-[length:100%_100%] bg-[bottom] text-white shadow-sm hover:bg-[length:100%_150%]">
            Register
          </button>
